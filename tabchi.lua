...
#راهنما
*/block (id)*
_بلاک کردن فرد از خصوصی ربات🎈👻_
*/unblock (id)*
_آنبلاک کردن فرد از خصوصي ربات✅_
*/panel*
_پنل مديريت ربات♻_
*/addsudo (id)*
_اضافه کردن سودوی جدید به ربات(یوزرنیم)_
*/remsudo (id)*
_حذف کاربراز لیست سودو های ربات(یوزرنیم)_
*/bc (text)*
_ارسال پيام به همه کاربران گروها و....(متن)_
*/fwd {all/gps/sgps/users}* (by reply)
_فوروارد پيام به همه/گروه ها/سوپر گروه ها/کاربران(ریپلی کردن)_
*/echo (text)*
_تکرار متن(متن)_
*/addedmsg (on/off)*
_تعیین روشن یا خاموش بودن پاسخ برای شر شن مخاطب♎_
*/setaddedmsg (text)*
_تنظیم متن ادد شدن مخاطب(متن)♉_
*/markread (on/off)*
_روشن يا خاموش کردن بازديد پيام ها🔰_
*/setanswer 'answer' text*
_ تنظيم به عنوان جواب اتوماتيک(جواب)(متن)_
*/delanswer (answer)*
_حذف جواب مربوط به(جواب)🏮_
*/answers*
_ليست جواب های اتوماتيک⚠_
*/addtoall*
_اضافه کردن مخاطبين ربات به گروه👻🎈_
*/addmembers*
_اضافه کردن شماره ها به مخاطبين ربات🎊_
*/exportlinks*
_دريافت لينک های ذخيره شده توسط ربات🎋_
*/contactlist*
_دريافت مخاطبان ذخيره شده توسط ربات🔮_
_سازنده_@sudo_star
]]
    return text
  end
